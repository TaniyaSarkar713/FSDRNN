...
def run_simulation(n_train=300, n_test=150, seed=42, device='cpu', verbose=False):
    ...
    with MethodTimer('Oracle FSDRNN') as timer:
        ...
        X_tr_oracle, Y_tr_oracle = X_train[tr_idx_oracle], Y_train_corr[tr_idx_oracle]
        X_val_oracle, Y_val_oracle = X_train[val_idx_oracle], Y_train_corr[val_idx_oracle]
        ...
        for r in range(oracle_restarts):
            ...
            val_error = evaluate_correlation_mse(Y_val_oracle, val_pred)
