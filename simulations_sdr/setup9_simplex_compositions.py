...
def run_simulation(n_train=300, n_test=150, seed=42, device='cpu', verbose=False):
    ...
    with MethodTimer('Oracle FSDRNN') as timer:
        ...
        for r in range(oracle_restarts):
            ...
            candidate = FSdrnnSimplexWrapper(
            ...
            val_error = evaluate_kl_divergence(Y_val_oracle, val_pred)
    ...
    results['methods']['Oracle FSDRNN'] = {
        ...
        'best_val_kl_divergence': best_oracle_val
    }
    ...
    if verbose:
        ...
        print(f"  Oracle best val KL: {best_oracle_val:.6f}")
