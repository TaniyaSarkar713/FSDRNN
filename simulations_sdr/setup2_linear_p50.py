...
def generate_synthetic_data(n, d0=2, p=50, V=8, noise_std=0.25, seed=42):
    """
...
def run_simulation(n_train=300, n_test=150, seed=42, verbose=False):
    ...
    start_time = time.time()
    oracle_method = OracleFSdrnnWrapper(input_dim, output_dim, B_true=beta, lr=5e-4, epochs=1000, dropout=0.1, device=device, verbose=False)
...
def main():
    parser = argparse.ArgumentParser(
        description='Linear-Nonlinear SDR Simulation (p=50): Compare 5 Methods'
    )
